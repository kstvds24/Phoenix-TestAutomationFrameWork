...
public class FakeDataGenerator {
	...
	public static CreateJobPayload generateFakeCreateJobData()
	{
		...
		return new CreateJobPayload(MST_SERVICE_LOCATION_ID, MST_PLATFORM_ID, MST_WARRANTY_STATUS_ID, MST_OEM_ID, customer, customerAddress, customerProduct, problemList);
	}
	public static Iterator<CreateJobPayload> generateFakeCreateJobData(int count)
	{
		...
		CustomerProduct customerProduct = generateFakeCustomerProductData();
		List<Problems> problemList = generateFakeProblemList();
		CreateJobPayload createJobPayload = new CreateJobPayload(MST_SERVICE_LOCATION_ID, MST_PLATFORM_ID, MST_WARRANTY_STATUS_ID, MST_OEM_ID, customer, customerAddress, customerProduct, problemList);
	...
	private static CustomerProduct generateFakeCustomerProductData() {
		...
		CustomerProduct customerProduct = new CustomerProduct(dob, imeiSerialNumber, imeiSerialNumber, imeiSerialNumber, popUrl, PRODUCT_ID, MST_MODEL_ID);
	...
	private static Customer generateFakeCustomerData() {
		...
		Customer customer = new Customer(fname, lname, customerMobileNumber, customerAltMobileNumber, customerEmailId, customerAltEmailId);
		return customer;
	}
}
