...
public class CreateJobAPIWithDBValidationTest {
	...
	public void setup() {
		...
		customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "92240341294098",
				"92240341294098", "92240341294098", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(),
	...
	public void createJobApiTest() {
		...
		int jobHeadId = response.then().extract().body().jsonPath().getInt("data.id");
		ProblemsDBModel problemsDataFromDb = ProblemsDao.getProblemsDBInfo(jobHeadId);
